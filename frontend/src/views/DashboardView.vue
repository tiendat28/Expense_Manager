...
<template>
  <PageShell>
    ...
    <div v-if="budget.monthlyBudget" class="bg-white rounded-2xl p-5 card-shadow">
    ...
    <div v-if="tx.monthlyStats.category_totals.length" class="bg-white rounded-2xl p-5 card-shadow">
